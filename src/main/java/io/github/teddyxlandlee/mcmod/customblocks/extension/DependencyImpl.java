/*
 * This file is copied from a part of Fabric Loader, without
 * any modification except the class name (from ModDependencyImpl).
 *
...
public final class DependencyImpl implements ModDependency {
	private final String modId;
	private final List<String> matcherStringList;
	private Set<VersionPredicate> ranges;

	public DependencyImpl(String modId, List<String> matcherStringList) {
		this.modId = modId;
